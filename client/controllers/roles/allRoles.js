...
let handle = Meteor.subscribe('modulesLive');
...
// A function which return an array of items(modules) selected -> a summary displayed for the user
getItemSelected = function(){
  var role = getValuesFromFormForAdd();
  var itemsArray = [];
  if (role.accountAdd == true||role.accountUpdate == true||role.accountDelete == true||role.accountDetails == true ||
    role.accountAuthorize == true||role.accountPrint == true|| role.accountDisplay == true) {
    var obj = {
      'item': "Accounts"
    };
    itemsArray.push(obj);
  }
  if (role.contractAdd == true||role.contractUpdate == true||role.contractDelete == true||role.contractDetails == true ||
     role.contractAuthorize == true||role.contractPrint == true|| role.contractDisplay == true) {
       var obj = {
         'item': "Contracts"
       };
       itemsArray.push(obj);
  }
  if (role.invoiceAdd == true||role.invoiceUpdate == true||role.invoiceDelete == true||role.invoiceDetails == true ||
     role.invoiceAuthorize == true||role.invoicePrint == true|| role.invoiceDisplay == true) {
       var obj = {
         'item': "Invoices"
       };
       itemsArray.push(obj);
  }
  if (role.articleAdd == true||role.articleUpdate == true||role.articleDelete == true||role.articleDetails == true ||
     role.articleAuthorize == true||role.articlePrint == true|| role.articleDisplay == true|| role.articleOptions == true) {
       var obj = {
         'item': "Articles"
       };
       itemsArray.push(obj);
  }
  if (role.clientAdd == true||role.clientUpdate == true||role.clientDelete == true||role.clientDetails == true ||
     role.clientAuthorize == true||role.clientPrint == true|| role.clientDisplay == true||role.clientInvoices == true ||
     role.clientRoles == true||role.clientUsers == true||role.clientBookings == true ||
     role.clientContracts == true||role.clientContents == true) {
       var obj = {
         'item': "Clients"
       };
       itemsArray.push(obj);
  }
  if (role.screenAdd == true||role.screenUpdate == true||role.screenDelete == true||role.screenDisplay == true ||
     role.screenPrint == true||role.screenAuthorize == true||role.screenDetails == true||role.screenShow == true||role.screenSystem == true ||
      role.screenClear == true||role.screenMonitor == true||role.screenActivate == true||role.screenOnOff == true) {
        var obj = {
          'item': "Screens"
        };
        itemsArray.push(obj);
  }
  if (role.segmentUpdate == true||role.segmentDelete == true||role.segmentDetails == true ||
    role.segmentAuthorize == true||role.segmentPrint == true|| role.segmentDisplay == true) {
      var obj = {
        'item': "Segments"
      };
      itemsArray.push(obj);
  }
  if (role.tariffAdd == true||role.tariffUpdate == true||role.tariffDelete == true||role.tariffDetails == true ||
    role.tariffAuthorize == true||role.tariffPrint == true|| role.tariffDisplay == true) {
      var obj = {
        'item': "Tariffs"
      };
      itemsArray.push(obj);
  }
  if (role.bookingAdd == true||role.bookingUpdate == true||role.bookingDelete == true||role.bookingDetails == true ||
    role.bookingAuthorize == true||role.bookingPrint == true|| role.bookingDisplay == true) {
      var obj = {
        'item': "Bookings"
      };
      itemsArray.push(obj);
  }
  if (role.contentAdd == true||role.contentDelete == true||role.contentDetails == true||role.contentAuthorize == true||role.contentPrint == true||role.contentDisplay == true) {
    var obj = {
      'item': "Contents"
    };
    itemsArray.push(obj);
  }
  if (role.roleAdd == true||role.roleUpdate == true||role.roleDelete == true||role.roleDetails == true||role.roleAuthorize == true ||
     role.rolePrint == true|| role.roleDisplay == true) {
       var obj = {
         'item': "Roles"
       };
       itemsArray.push(obj);
  ...
  var firmwares = false;
  if (role.firmwareAdd == true||role.firmwareUpdate == true||role.firmwareDelete == true||role.firmwareDetails == true ||
    role.firmwareAuthorize == true||role.firmwarePrint == true|| role.firmwareDisplay == true) {
      var obj = {
        'item': "Firmwares"
      };
      itemsArray.push(obj);
  }
  if (role.signatureAdd == true||role.signatureDelete == true||role.signaturePrint == true|| role.signatureDisplay == true) {
    var obj = {
      'item': "Signatures"
    };
    itemsArray.push(obj);
  }
  if (role.currencyAdd == true||role.currencyUpdate == true||role.currencyDelete == true||role.currencyDetails == true ||
    role.currencyAuthorize == true||role.currencyPrint == true|| role.currencyDisplay == true) {
      var obj = {
        'item': "Currencies"
      };
      itemsArray.push(obj);
  }
  if (role.companyAdd == true||role.companyUpdate == true||role.companyDelete == true||role.companyDisplay == true ||role.companyPrint == true||
    role.companyAuthorize == true||role.companyDetails == true||role.companyInvoices == true||role.companyRoles == true ||
    role.companyUsers == true||role.companySegments == true||role.companyContracts == true||role.companyScreens == true ||
    role.companyBookings == true||role.companyContents == true||role.companyCurrencies == true||role.companyClients == true||
    role.companyTariffs == true||role.companyFirmwares == true) {
      var obj = {
        'item': "Contracts"
      };
      itemsArray.push(obj);
  }
  if (role.moduleAdd == true||role.moduleUpdate == true||role.moduleDelete == true||role.moduleDetails == true ||
    role.moduleAuthorize == true||role.modulePrint == true|| role.moduleDisplay == true) {
      var obj = {
        'item': "Modules"
      };
      itemsArray.push(obj);
  }
  if (role.planningAdd == true||role.planningUpdate == true||role.planningDelete == true||role.planningDetails == true ||
    role.planningAuthorize == true||role.planningPrint == true|| role.planningDisplay == true) {
      var obj = {
        'item': "Plannings"
      };
      itemsArray.push(obj);
...
Template.allRoles.events({
  ...
  'click .BtnAuthorize'() {
    ...
    role.code = Session.get("UserLogged").code;
    authorize(role);
  },
  'click .summary'() {
...
Template.allRoles.helpers({
  ...
  roles_authorization() {
    var roles = Roles_Authorization.find({ "codeCompany" : Session.get("UserLogged").codeCompany, "code": Session.get("UserLogged").code });
  ...
  isSwallowLabsUser: function() {
    return whoIsConnected() == "swallow-labs";
  },
  isClientUser: function() {
    return whoIsConnected() == "client";
  },
