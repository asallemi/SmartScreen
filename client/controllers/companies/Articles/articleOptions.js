...
Template.articleOptions.rendered = function(){
  checkSession();
  settingLanguage();
  $('.footable').footable();
  $('.footable2').footable();
...
Template.articleOptions.events({
...
Template.articleOptions.helpers({
  ...
  optionsAuthorization (){
    var options = Articles_Options_Authorization.find({ "codeCompany": Session.get("COMPANY_CODE") });
