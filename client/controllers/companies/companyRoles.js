...
Template.companyRoles.rendered = function(){
  checkSession();
  settingLanguage();
...
Template.companyRoles.helpers({
  ...
  roles_authorization() {
    var roles = Roles_Authorization.find({ "codeCompany": Session.get("COMPANY_CODE"), "code": null });
