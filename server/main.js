if (Meteor.isServer) {
  Meteor.startup(function () {
    ...
    exec2('fusermount -u /home/akrem/packages/;rm -rf /home/akrem/packages/;mkdir /home/akrem/packages/;echo reverse | sshfs root@10.10.10.2:/var/ftp/pub/localrepo /home/akrem/packages/ -o  password_stdin', function (error, stdout, stderr) {
      //console.log("STDOUT"+stdout);
      console.log("ERROR"+error);
    });
